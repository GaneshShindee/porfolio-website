  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center z-10">
        ...
        <Link href="https://github.com/GaneshShindee/porfolio-website.git">
          <MagicButton
      ...
      <div className="relative flex mt-16 md:flex-row flex-col gap-3 justify-between items-center z-10">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2025 Ganesh Shinde
        </p>

        <div className="flex items-center md:gap-3 gap-6">
          <div className="w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300">
            <Link href="https://github.com/GaneshShindee">
              <Image src={whitegithub} alt="icons" width={30} height={30} />
            </Link>
          </div>
          <div className="w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300">
            <Link href="https://www.linkedin.com/in/ganeshshindeviit/">
